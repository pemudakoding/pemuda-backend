...
@section('page','Tambah Landing Page')

@section('content')
	<div class="card">
        <form action="{{ route('hero-apps.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-header d-flex justify-content-between">
                <strong>Tambah Landing Page</strong>
                <button class="btn btn-primary btn-sm" type="submit">Tambah Landing Page</button>
            </div>
